...
const CampaignsConfig = () => {
  ...
  const saveSettings = async () => {
    ...
    toast.success(i18n.t("campaignsConfig.saved"));
  };
          ...
          <Grid spacing={2} container>
            ...
            <Grid xs={12} md={4} item>
              ...
              >
                ...
                >
                  <MenuItem value={0}>{i18n.t("campaignsConfig.noInterval")}</MenuItem>
            ...
            <Grid xs={12} md={4} item>
              ...
              >
                ...
                <Select
                  ...
                  onChange={(e) => handleOnChangeSettings(e)}
                >
                  <MenuItem value={0}>{i18n.t("campaignsConfig.notDefined")}</MenuItem>
                  <MenuItem value={1}>1 {i18n.t("campaignsConfig.second")}</MenuItem>
                  <MenuItem value={5}>5 {i18n.t("campaignsConfig.seconds")}</MenuItem>
                  <MenuItem value={10}>10 {i18n.t("campaignsConfig.seconds")}</MenuItem>
                  <MenuItem value={15}>15 {i18n.t("campaignsConfig.seconds")}</MenuItem>
                  <MenuItem value={20}>20 {i18n.t("campaignsConfig.seconds")}</MenuItem>
            ...
            {showVariablesForm && (
              <>
                <Grid xs={12} md={6} item>
                  <TextField
                    label={i18n.t("campaignsConfig.shortcut")}
                    variant="outlined"
                    value={variable.key}
                    name="key"
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{i18n.t("campaignsConfig.shortcut")}</TableCell>
