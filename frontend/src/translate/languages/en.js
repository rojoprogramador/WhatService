    ...
    translations: {
      ...
      mainDrawer: {
        ...
        appBar: {
          ...
          welcomeWithLicense: "Hello! {name}, Welcome to {company}! (license until: {date})",
      ...
      messagesAPI: {
        ...
        tokenRegistration: "Before sending messages, it is necessary to register the token linked to the connection that will send the messages. To register, access the \"Connections\" menu, click the edit button of the connection and insert the token in the appropriate field.",
        numberFormat: "The number for sending should not have a mask or special characters and should be composed of:",
        countryCode: "Country code",
        areaCode: "Area code",
        phoneNumber: "Number",
        textMessages: "1. Text Messages",
        textInstructions: "Below is the list of information needed to send text messages:",
        endpoint: "Endpoint:",
        method: "Method:",
        headers: "Headers:",
        body: "Body:",
        testSend: "Send Test",
        mediaMessages: "2. Media Messages",
        send: "Send",
        documentationTitle: "Documentation for sending messages",
        sendingMethods: "Sending Methods",
        textMessagesItem: "Text Messages",
        mediaMessagesItem: "Media Messages",
        textMessage: {
          number: "Number",
          body: "Message",
      ...
      announcements: {
        ...
        permissions: {
          noAccess: "This company does not have permission to access this page! We are redirecting you.",
        },
      },
      campaignsConfig: {
