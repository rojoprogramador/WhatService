  ...
  es: {
    translations: {
      ...
      dashboard: {
        ...
        filters: {
          parameterizeFilter: "Parametrice el filtro",
          ...
          selectPeriod: "Seleccione el período deseado",
      ...
      mainDrawer: {
        ...
        appBar: {
          ...
          welcomeWithLicense: "¡Hola! {name}, ¡Bienvenido a {company}! (licencia hasta: {date})",
      ...
      messagesAPI: {
        ...
        tokenRegistration: "Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. Para realizar el registro, acceda al menú \"Conexiones\", haga clic en el botón editar de la conexión e inserte el token en el campo correspondiente.",
        numberFormat: "El número para el envío no debe tener máscara o caracteres especiales y debe estar compuesto por:",
        countryCode: "Código del país",
        areaCode: "Código de área",
        phoneNumber: "Número",
        textMessages: "1. Mensajes de Texto",
        textInstructions: "A continuación se presenta la lista de información necesaria para el envío de mensajes de texto:",
        endpoint: "Endpoint:",
        method: "Método:",
        headers: "Headers:",
        body: "Body:",
        testSend: "Prueba de Envío",
        mediaMessages: "2. Mensajes de Media",
        send: "Enviar",
        documentationTitle: "Documentación para envío de mensajes",
        sendingMethods: "Métodos de Envío",
        textMessagesItem: "Mensajes de Texto",
        mediaMessagesItem: "Mensajes de Media",
        textMessage: {
          number: "Número",
          body: "Mensaje",
      ...
      announcements: {
        ...
        permissions: {
          noAccess: "Esta empresa no tiene permiso para acceder a esta página! Le estamos redirigiendo.",
        },
      },
      campaignsConfig: {
      ...
      settings: {
        ...
        options: {
          ...
          ratingsDisabled: "Deshabilitadas",
          scheduleManagement: "Gestión de Horario de Trabajo",
          ignoreGroupMessages: "Ignorar Mensajes de Grupos",
          acceptCalls: "Aceptar Llamadas",
          chatbotType: "Tipo de Chatbot",
          sendGreetingAccepted: "Enviar saludo al aceptar el ticket",
          sendTransferMessage: "Enviar mensaje de transferencia de Cola/agente", 
          sendGreetingOneQueue: "Enviar saludo cuando haya solo 1 cola",
          registerAllowed: "Registro (Inscripción) Permitido?",
          registerVisible: "Registro (Inscripción) Visible?",
          trialTime: "Tiempo de Trial?",
          integrations: "INTEGRACIONES",
          activated: "Activado",
      ...
      messagesInput: {
        placeholderOpen: "Escribe tu mensaje aquí...",
        placeholderClosed:
          "Reabre o toma este ticket para enviar un mensaje.",
        signMessage: "Firmar",
      },
      contactDrawer: {
